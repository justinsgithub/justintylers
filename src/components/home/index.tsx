        ...
        <Box mx={1}>
          ...
          <Box maxWidth={900} mx='auto'>
            <Typography variant='subtitle1' my={3}>
              Thank you for taking the time to visit my site. Hopefully you find some of this content helpful.
              Other content coming soon, please share with anyone you think may benefit. Find me on{' '}
